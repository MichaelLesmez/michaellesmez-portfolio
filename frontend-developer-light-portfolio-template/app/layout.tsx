...
export const metadata: Metadata = {
	title: 'Michael Lesmez - Full StackDeveloper',
	description:
	...
	authors: [{ name: 'Michael Lesmez' }],
	creator: 'Michael Lesmez',
	openGraph: {
		title: 'Michael Lesmez - Frontend Developer Portfolio',
		...
		siteName: 'Michael Lesmez - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Michael Lesmez - Frontend Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
	...
	twitter: {
		...
		title: 'Michael Lesmez - Frontend Developer',
		description: 'Passionate frontend developer crafting beautiful and interactive web experiences. Explore my projects and frontend development expertise.',
